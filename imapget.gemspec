...
Gem::Specification.new do |s|
  ...
  s.rdoc_options = ["--title".freeze, "imapget Application documentation (v0.2.1)".freeze, "--charset".freeze, "UTF-8".freeze, "--line-numbers".freeze, "--all".freeze, "--main".freeze, "README".freeze]
